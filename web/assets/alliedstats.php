...
$tdd =  mysqli_query($dbconn, "SELECT ddcallsign, ddpoints FROM scoring_top_players WHERE side ='1' AND period = 'camp' ORDER BY ddpoints DESC LIMIT 1") ;
$tpb =  mysqli_query($dbconn, "SELECT pbcallsign, pbpoints FROM scoring_top_players WHERE side ='1' AND period = 'camp' ORDER BY pbpoints DESC LIMIT 1") ;
$ttt =  mysqli_query($dbconn, "SELECT ttcallsign, ttpoints FROM scoring_top_players WHERE side ='1' AND period = 'camp' ORDER BY ttpoints DESC LIMIT 1") ;
...
$ddd =  mysqli_query($dbconn, "SELECT ddcallsign, ddpoints FROM scoring_top_players WHERE side ='1' AND period = 'day' ORDER BY ddpoints DESC LIMIT 1") ;
$dpb =  mysqli_query($dbconn, "SELECT pbcallsign, pbpoints FROM scoring_top_players WHERE side ='1' AND period = 'day' ORDER BY pbpoints DESC LIMIT 1") ;
$dtt =  mysqli_query($dbconn, "SELECT ttcallsign, ttpoints FROM scoring_top_players WHERE side ='1' AND period = 'day' ORDER BY ttpoints DESC LIMIT 1") ;
