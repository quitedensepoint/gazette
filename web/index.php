...
<head>        
    <title>WWIIOnline Gazette</title>
...
<!-- Front Line Map -->
				<td rowspan='2' colspan='3'>
					<a href='http://snipets.net/WebMap/2.0/WebMap.php'><img src='http://snipets.net/WebMap/2.0/GazetteFrontPage.png'></a>
					<span id="mapText" class='paperwhite'>GAME MAP UPDATES EVERY 15 MINUTES - <a href='http://snipets.net/WebMap/2.0/WebMap.php' style="color: yellow;">CLICK FOR FULL SIZE</a></span>
				</td>
