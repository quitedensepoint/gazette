package Playnet::Content::PLAYER_BestShoreBombardment;
...
{
	### add handler
	$main::source_vars{'52'} = \&Playnet::Content::PLAYER_BestSortie::handleContent;
	
	### add statements
	&addStatement('community_db','52_sortie_select',q{
		SELECT k.sortie_id,
			count(*) as kills,
			'5' as goal
