package Playnet::Content::PLAYER_BestSapper;
...
{
	### add handler
	$main::source_vars{'49'} = \&Playnet::Content::PLAYER_BestSortie::handleContent;
	
	### add statements
	&addStatement('community_db','49_sortie_select',q{
		SELECT k.sortie_id,
			count(*) as kills,
			'1' as goal
