...
<!-- Placeholder image -->      <div align='center'><a href='http://map.wwiionline.com/belgium_front.html')>
                        ...
                        <tr bgcolor='#000000'>
<!--Link commented pending map restoration <td align='center' class='paperdefault'> <span class='paperwhite'>GAME MAP UPDATED EVERY 5 MINUTES - <a href=http://map.wwiionline.com/belgium_front.html'>CLICK FOR FULL SIZE</a></span> </td> -->
                        </tr>
                    </table>
                </td>
<!-- end Map -->    
                    ...
                    <table width='100%' border='0' cellspacing='0' cellpadding='0' name='below_map_content1'>
                        ...
                        <tr align='left' valign='top'>
                            <td>
                                <table width='100%' border='0' cellspacing='0' cellpadding='5'>
                                    <tr>
<!--Axis Player Story -->             <td>
<!-- #include file='/home/bv55/scriptinc/paper/index_axis_stats1.html' -->
                                                <table width='100%' border='0' cellspacing='0' cellpadding='0'>
                                                            <tr align='left' valign='top'> 
                                                                <td> 
                                                                    <font size='3' face='Times New Roman, Times, serif'>
                                                                    <b><span class='papertimesbig'>Possible US Stat Spot</span>                                                               </b>
                                                                    </font>
                                                                    <br>
                                                                    <font size='1' face='Arial, Helvetica, sans-serif'>
