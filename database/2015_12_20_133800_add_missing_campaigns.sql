-- This script fixes the issue with the missing campaigns from
-- the gazette record (104 - 119)

UPDATE `campaigns` SET `status` = 'Completed', `stop_time` = '2014-09-12 19:33:15' WHERE `campaign_id` = 104;

-- Insert missing values
INSERT INTO `campaigns` (`campaign_id`, `status`, `start_time`, `stop_time`)
